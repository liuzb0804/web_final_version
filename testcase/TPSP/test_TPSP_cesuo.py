...
class Test_basic(mytest.MyTest):
    ...
    def test_basic_test(self):
        ...
        time.sleep(3)
        self.dr.type('name->name','cesuo')#名称

        self.dr.click('xpath->//*[@id="regionSelector"]/div[3]')
        time.sleep(2)
        self.dr.click('xpath->//*[@id="regionSelector"]/div[3]/ul/li[2]')

        self.dr.click('xpath->//*[@id="dataForm"]/div[2]/div/button')#所属地区
