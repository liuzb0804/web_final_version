...
class PySelenium(object):
    ...
    def sleep(self,seconds):
        ...
        try:
            time.sleep(seconds)
            self.my_print("Sleep for {} seconds" .format(seconds,time.time()-t1))
        except Exception:
            self.my_print("Sleep Failed Need Check!" .format(seconds,time.time()-t1))
            raise

    def get_elements(self, css):
        """
        Judge element positioning way, and returns element list.
    ...
    # def action_elements(self,number):
    #     """
    #     action elements One or more of the sets
    #     :param number:int ,list
    #     :return:
    #     """
    #
    #     if number == int:
    #         element = self.get_elements[int]
    #         return element
    #     elif number == list:
    #         for i in list:
    #             element = self.get_elements[i]
    #
    #     elif number == all:
